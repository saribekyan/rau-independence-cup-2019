# the solution uses a stripped down version of
...
def solution(A):
    ...
    for iInd in range(1, n + 1):
        ...
        leftRange = Slopes.irange(-INF, i, reverse=True)
        ...
        if inserti:
            ...
            rightRange = Slopes.irange(i + 1, +INF)
