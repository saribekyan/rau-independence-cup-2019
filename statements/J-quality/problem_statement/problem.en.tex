...
\section*{Input}
The first line of the input contains a single integer $n$ ($1 \leq n \leq 10^9$), the length of the strings.\hnote{It would be good to make this $10^6$ without creating an easier solution. Because $10^9$ means that some tricks are needed, a linear pass over $n$ will not work.}
