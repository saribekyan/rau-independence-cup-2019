...
\section*{Input}
The first line of the input contains two integers $n$ and $m$ ($1 \leq n, m \leq 50000$), the number of code words that Armen and Vartan can use\enote{Maybe this should be "number of words that Armen can read?"}\hnote{better?}, and the number of messages Armen receives.
