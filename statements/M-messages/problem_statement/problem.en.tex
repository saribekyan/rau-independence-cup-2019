...
\section*{Input}
The first line of the input contains two integers $n$ and $m$ ($1 \leq n, m \leq 50000$), the number of code words in Armen's and Vartan's dictionary \enote{Maybe this should be "number of words that Armen can read?"}, and the number of messages Armen receives.
